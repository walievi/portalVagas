                            ...
                            @foreach ($formacoes as $formacao)
                                <tr>
                                    ...
                                    <td class='actions'>
                                        ...
                                        <a class='btn btn-danger btn-xs delete-pergunta-btn' href='#' data-toggle='modal' data-target='#confirmDeleteModal' data-url="{{ route('formacao.destroy', ['formacao' => $formacao->id]) }}"><span class='glyphicon glyphicon-ok' aria-hidden='true'></span> Excluir</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
