...
<div class="background">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center mt-5">Vagas disponíveis</h2>
                ...
                <div class="card">
                    <div class="card-body card-body-home" style="margin: 0 auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <p class="card-text">Ensino Superior Completo</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-1">
                            ...
                            <div class="col-md-9">
                                <p class="card-text">Unidade Pindorama - NH</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-1">
                            ...
                            <div class="col-md-9">
                                <p class="card-text">Segunda a sexta das 8h ás 17h</p>
                            </div>
                        </div>
